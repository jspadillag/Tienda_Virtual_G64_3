...
<body>
	...
	<div class="mx-auto" style="width: 700px;" >
		<form class="row g-3 needs-validation">
			...
			<div class="col-md-6">
				<label for="inputNombre_proveedor" class="form-label">Nombre proveedor</label>
				<input type="text" class="form-control" id="inputNombre_proveedor"
					name="nombre_proveedor" aria-describedby="inputGroupPrepend" required>
				<div class="invalid-feedback">Por favor ingrese el nombre proveedor.</div>
