...
public class DetalleVentas {
	...
	public DetalleVentas( int codigo_detalle_venta, int cantidad_producto, int codigo_producto, int codigo_venta, double valor_total, double valor_venta, double valoriva) {
