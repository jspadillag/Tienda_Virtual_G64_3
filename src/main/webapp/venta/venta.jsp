	...
	<div class="mx-auto" style="width: 700px;">
		<form id="form" class="row g-3 needs-validation">
			...
			<div style="display: flex; align-items: center;" >	
				...
				<button type="button" onclick="buscarProducto(1)" class="btn btn-success" >Buscar</button>
			</div>	
			</div>
			<div  class="col-md-3 position-relative" >
			...
			<div style="display: flex; align-items: center;" class="col-md-3 position-relative">
				 <input type="text"
					...
					aria-describedby="inputGroupPrepend">
				<button type="button" onclick="buscarProducto(2)" class="btn btn-success">Buscar</button>
			</div>	
			<div style="display: flex; align-items: center;" class="col-md-3 position-relative">	
				 <input type="text"
			...
			<div style="display: flex; align-items: center;" class="col-md-3 position-relative">
				 <input type="text"
					...
					aria-describedby="inputGroupPrepend">
				<button type="button" onclick="buscarProducto(3)" class="btn btn-success">Buscar</button>
			</div>	
			<div style="display: flex; align-items: center;" class="col-md-3 position-relative">	
				 <input type="text"
